...
CREATE TABLE Comment (id BIGSERIAL NOT NULL, bugId INT NOT NULL,authorId INT NOT NULL, text VARCHAR(255) NOT NULL, creationDate DATE DEFAULT CURRENT_TIMESTAMP, imageURL VARCHAR(200),voteCount INT DEFAULT 0,PRIMARY KEY(id),FOREIGN KEY(bugId) REFERENCES Bug(id) ON DELETE CASCADE,FOREIGN KEY(authorId) REFERENCES Users(id) ON DELETE CASCADE);
