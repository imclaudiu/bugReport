CREATE TABLE Users (id INT NOT NULL ,username VARCHAR(100) NOT NULL,email VARCHAR(100) NOT NULL UNIQUE,password VARCHAR(100) NOT NULL,phone VARCHAR(100),score FLOAT(10),isModerator BOOLEAN DEFAULT FALSE,isBanned BOOLEAN DEFAULT FALSE,PRIMARY KEY(id));
